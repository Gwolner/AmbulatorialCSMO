...
class pdfreport_licenca_tratamento_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_licenca_tratamento_csv()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".csv";
      $this->Tit_doc    = "pdfreport_licenca_tratamento.csv";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['csv_name']);
      }
      $this->Res           = new pdfreport_licenca_tratamento_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['arr_export']['data'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['pivot_tabular'];
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
