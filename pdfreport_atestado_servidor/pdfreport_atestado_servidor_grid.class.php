<?php
class pdfreport_atestado_servidor_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_atestado_servidor']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_atestado_servidor", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_atestado_servidor']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_atestado_servidor']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_atestado_servidor']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_atestado_servidor']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['labels']['id_usuario'] = "Id Usuario";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['labels']['nome_parte1'] = "nome_parte1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['labels']['nome_parte2'] = "nome_parte2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['labels']['dia'] = "dia";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['labels']['mes'] = "mes";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['labels']['ano'] = "ano";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['labels']['numer_de_dias'] = "numer_de_dias";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_atestado_servidor']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_atestado_servidor']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_atestado_servidor']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['qt_col_grid']) 
      {  
...
$_SESSION['scriptcase']['pdfreport_atestado_servidor']['contr_erro'] = 'off';
          ...
          $this->numer_de_dias[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->numer_de_dias[$this->nm_grid_colunas]);
            $cell_nome_parte1 = array('posx' => 50, 'posy' => 68, 'data' => $this->nome_parte1[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_nome_parte2 = array('posx' => 13, 'posy' => 74, 'data' => $this->nome_parte2[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_dia = array('posx' => 24, 'posy' => 102, 'data' => $this->dia[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_mes = array('posx' => 36, 'posy' => 103, 'data' => $this->mes[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_ano = array('posx' => 66, 'posy' => 102, 'data' => $this->ano[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
