<form name="F2" method=post 
               action="control_receituario_mob.php" 
               target="_self"> 
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_receituario_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
   ...
   document.F4.action               = "control_receituario_mob_fim.php";
   document.F4.submit(); 
} 
