...
class grid_atendimento_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_tipo_servico;
   var $array_total_procedimento;
   var $array_total_tipo_paciente;
   var $array_total_data_hora;
   ...
   //---- 
   function grid_atendimento_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['contr_total_geral'] == "OK")
      {
          $this->array_total_tipo_servico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['tipo_servico'];
          $this->array_total_procedimento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['procedimento'];
          $this->array_total_tipo_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['tipo_paciente'];
          $this->array_total_data_hora = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['data_hora'];
      }
      else
      {
          $this->array_total_tipo_servico = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['tipo_servico'] = $this->array_total_tipo_servico;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['procedimento'] = $this->array_total_procedimento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['tipo_paciente'] = $this->array_total_tipo_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_total']['data_hora'] = $this->array_total_data_hora;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['tipo_servico'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels'][''] = ""; 
       $prep_field['procedimento'] = "Procedimento";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels'][''] = "Procedimento"; 
       $prep_field['tipo_paciente'] = "Tipo Paciente";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels'][''] = "Tipo Paciente"; 
       $prep_field['data_hora'] = "Data Hora";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels'][''] = "Data Hora"; 
       $Str_gb = "";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['tipo_servico']['alin'] = "''";
       $Arr_parms['tipo_servico']['link'] = "S";
       $Arr_parms['procedimento']['alin'] = "''";
       $Arr_parms['procedimento']['link'] = "S";
       $Arr_parms['tipo_paciente']['alin'] = "''";
       $Arr_parms['tipo_paciente']['link'] = "S";
       $Arr_parms['data_hora']['alin'] = "''";
       $Arr_parms['data_hora']['link'] = "S";
       $Arr_parms['tipo_servico']['fill'] = "true";
       $Arr_parms['tipo_servico']['order'] = "label";
       $Arr_parms['procedimento']['fill'] = "true";
       $Arr_parms['procedimento']['order'] = "label";
       $Arr_parms['tipo_paciente']['fill'] = "true";
       $Arr_parms['tipo_paciente']['order'] = "label";
       $Arr_parms['data_hora']['fill'] = "true";
       $Arr_parms['data_hora']['order'] = "value";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['tipo_servico'] = array(0 => 'tipo_servico', 1 => '@aspass@');
       $prep_links_fl['procedimento'] = array(0 => 'procedimento', 1 => '@aspass@');
       $prep_links_fl['tipo_paciente'] = array(0 => 'tipo_paciente', 1 => '@aspass@');
       $prep_links_fl['data_hora'] = array(0 => 'data_hora', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("")),
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Procedimento")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Tipo Paciente")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Data Hora")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_atendimento_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_atendimento_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_atendimento_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] = "print";
      ...
      $this->total   = new grid_atendimento_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_tipo_servico, $this->array_total_procedimento, $this->array_total_tipo_paciente, $this->array_total_data_hora);
      ksort($this->array_total_tipo_servico);
      ksort($this->array_total_procedimento);
      ksort($this->array_total_tipo_paciente);
      ksort($this->array_total_data_hora);
      if ("out" == $this->NM_tipo)
      {
         $this->total->quebra_geral();
      }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_titl'] . " - atendimento</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['doc_word'])
{
      ...
      $sFusionChartModule = grid_atendimento_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = grid_atendimento_grafico::getChartModule('Bar');
      }
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_atendimento_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_atendimento_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_atendimento_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_atendimento/grid_atendimento_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_atendimento/grid_atendimento_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=pt_br&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_atendimento/grid_atendimento_config_word.php?nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_atendimento/grid_atendimento_config_print.php?nm_opc=resumo&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
         ...
         if (is_file("grid_atendimento_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_atendimento/grid_atendimento_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_atendimento/grid_atendimento_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_atendimento_config_pivot.php?nome_apl=grid_atendimento&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_atendimento/grid_atendimento_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_atendimento_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_atendimento/grid_atendimento_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_atendimento_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TABLE border=\"0px\" cellpadding=\"0px\" cellspacing=\"20px\" align=\"center\" valign=\"top\" " . $summary_width . ">\r\n");
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $id_atendimento = $Busca_temp['id_atendimento']; 
          ...
          $id_atendimento_2 = $Busca_temp['id_atendimento_input_2']; 
          $id_servidor_saude = $Busca_temp['id_servidor_saude']; 
          ...
          $id_servidor_saude_2 = $Busca_temp['id_servidor_saude_input_2']; 
          $tipo_servico = $Busca_temp['tipo_servico']; 
          $tmp_pos = strpos($tipo_servico, "##@@");
          if ($tmp_pos !== false)
          {
              $tipo_servico = substr($tipo_servico, 0, $tmp_pos);
          }
          $procedimento = $Busca_temp['procedimento']; 
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_smry_titl'] . " - atendimento</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_tipo_servico, $quebra_procedimento, $quebra_tipo_paciente, $quebra_data_hora, $quebra_tipo_servico_orig, $quebra_procedimento_orig, $quebra_tipo_paciente_orig, $quebra_data_hora_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->procedimento = $rs_res->fields[0] ;  
            $this->id_atendimento = $rs_res->fields[1] ;  
            $this->id_servidor_saude = $rs_res->fields[2] ;  
            $this->tipo_servico = $rs_res->fields[3] ;  
            $this->tipo_paciente = $rs_res->fields[4] ;  
            $this->data_hora = $rs_res->fields[5] ;  
            $this->data_hora = substr($this->data_hora, 0, 10);
            $this->tipo_servico_orig = $this->tipo_servico;
            $this->procedimento_orig = $this->procedimento;
            $this->tipo_paciente_orig = $this->tipo_paciente;
            $this->data_hora_orig = $this->data_hora;
...
$_SESSION['scriptcase']['grid_atendimento']['contr_erro'] = 'off'; 
            ...
            { 
                $this->nm_data->SetaData($this->data_hora, "YYYY-MM-DD");
                $this->data_hora = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "ddmmaaaa"));
            } 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tipo_servico, $this->procedimento, $this->tipo_paciente, $this->data_hora, $this->tipo_servico_orig,  $this->procedimento_orig,  $this->tipo_paciente_orig,  $this->data_hora_orig);
            }
   }
//
