<?php
//
class control_licenca_tratamento_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->global_nome_servidor)) 
          {
              $_SESSION['global_nome_servidor'] = $this->global_nome_servidor;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_licenca_tratamento_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['initialize'])
          {
...
$_SESSION['scriptcase']['control_licenca_tratamento_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['control_licenca_tratamento_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_licenca_tratamento_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_licenca_tratamento_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_licenca_tratamento_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_licenca_tratamento_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_licenca_tratamento_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_licenca_tratamento_mob']['label'] = "Licença para tratamento de saúde inferior a 15 dias";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "control_licenca_tratamento_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['control_licenca_tratamento_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_licenca_tratamento_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_licenca_tratamento_mob']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("control_licenca_tratamento_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_licenca_tratamento_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_licenca_tratamento_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'control_licenca_tratamento/control_licenca_tratamento_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_licenca_tratamento_mob_erro.class.php"); 
      }
      $this->Erro      = new control_licenca_tratamento_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_licenca_tratamento_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['Lookup_nome']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['Lookup_nome'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['Lookup_nome']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['Lookup_nome'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(control_licenca_tratamento_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => control_licenca_tratamento_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['Lookup_nome'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->numero_de_dias = "" ;  
          $this->cid = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['recarga'] = $this->nmgp_opcao;
      }
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos']))
              { 
                  $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][0]; 
                  $data_nascimento = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][1]; 
                  $cpf = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][2]; 
                  $orgao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][3]; 
                  $siape = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][4]; 
                  $data_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][5]; 
                  $data_final = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][6]; 
                  $numero_de_dias = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][7]; 
                  $cid = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][8]; 
                  $data_hoje = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][9]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][0] = $this->nome; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][1] = $this->data_nascimento; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][2] = $this->cpf; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][3] = $this->orgao; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][4] = $this->siape; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][5] = $this->data_inicial; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][6] = $this->data_final; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][7] = $this->numero_de_dias; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][8] = $this->cid; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['campos'][9] = $this->data_hoje; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_licenca_tratamento_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_licenca_tratamento_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_licenca_tratamento_mob']) || !is_array($this->NM_ajax_info['errList']['geral_control_licenca_tratamento_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_control_licenca_tratamento_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_licenca_tratamento_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('pdfreport_licenca_tratamento') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_control_licenca_tratamento_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['control_licenca_tratamento_mob']['contr_erro'] = 'off'; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][control_licenca_tratamento_mob_pack_protect_string(NM_charset_to_utf8($this->nome))]) ? $aLookup[0][control_licenca_tratamento_mob_pack_protect_string(NM_charset_to_utf8($this->nome))] : "";
   ...
   function ajax_return_values_data_hoje($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->nm_formatar_campos();
    include_once("control_licenca_tratamento_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "control_licenca_tratamento_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_licenca_tratamento_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['masterValue'] as $cmp_master => $val_master)
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['retorno_edit'] = "";
   }
