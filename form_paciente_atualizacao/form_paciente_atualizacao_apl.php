<?php
//
class form_paciente_atualizacao_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['total']))
          {
              $_SESSION['sc_session'][$script_case_init]['form_visitante_atualizacao']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_visitante_atualizacao']['total']);
              $_SESSION['sc_session'][$script_case_init]['form_aluno_atualizacao']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_aluno_atualizacao']['total']);
              $_SESSION['sc_session'][$script_case_init]['form_servidor_atualizacao']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_servidor_atualizacao']['total']);
              $_SESSION['sc_session'][$script_case_init]['form_servidor_terceirizado_atualizacao']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_servidor_terceirizado_atualizacao']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->id_paciente_global)) 
          {
              $_SESSION['id_paciente_global'] = $this->id_paciente_global;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_paciente_atualizacao_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['initialize'])
          {
...
$_SESSION['scriptcase']['form_paciente_atualizacao']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_paciente_atualizacao']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_paciente_atualizacao']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_paciente_atualizacao'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_paciente_atualizacao']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_paciente_atualizacao']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_paciente_atualizacao') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_paciente_atualizacao']['label'] = "Atualizar dados do Paciente";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_paciente_atualizacao")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_paciente_atualizacao']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_paciente_atualizacao'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente_atualizacao']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_paciente_atualizacao", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_paciente_atualizacao/form_paciente_atualizacao_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_paciente_atualizacao_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_paciente_atualizacao_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_paciente_atualizacao_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_paciente_atualizacao/form_paciente_atualizacao_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_paciente_atualizacao_erro.class.php"); 
      }
      $this->Erro      = new form_paciente_atualizacao_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao']))
         { 
             if ($this->id_paciente != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente_atualizacao']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_visitante_atualizacao') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_visitante_atualizacao') . "/form_visitante_atualizacao_apl.php");
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_aluno_atualizacao') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_aluno_atualizacao') . "/form_aluno_atualizacao_apl.php");
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_servidor_atualizacao') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_servidor_atualizacao') . "/form_servidor_atualizacao_apl.php");
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_servidor_terceirizado_atualizacao') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_servidor_terceirizado_atualizacao') . "/form_servidor_terceirizado_atualizacao_apl.php");
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_paciente_atualizacao']) || !is_array($this->NM_ajax_info['errList']['geral_form_paciente_atualizacao']))
              {
                  $this->NM_ajax_info['errList']['geral_form_paciente_atualizacao'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_paciente_atualizacao'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_nome_paciente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['nome_paciente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['nome_paciente'] == "on")) 
      { 
    ...
    function ValidateField_cep(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['cep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['cep'] == "on") 
           { 
              $Campos_Falta[] = "CEP" ; 
              if (!isset($Campos_Erros['cep']))
              {
    ...
    function ValidateField_data_nascimento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_data_nascimento' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['data_nascimento'] == "on")) 
           { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_paciente']['keyVal'] = form_paciente_atualizacao_pack_protect_string($this->nmgp_dados_form['id_paciente']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total'] < 0)
              {
...
$aLookup[] = array(form_paciente_atualizacao_pack_protect_string('aluno') => form_paciente_atualizacao_pack_protect_string("Aluno"));
$aLookup[] = array(form_paciente_atualizacao_pack_protect_string('servidor') => form_paciente_atualizacao_pack_protect_string("Servidor"));
$aLookup[] = array(form_paciente_atualizacao_pack_protect_string('terceirizado') => form_paciente_atualizacao_pack_protect_string("Terceirizado"));
$aLookup[] = array(form_paciente_atualizacao_pack_protect_string('visitante') => form_paciente_atualizacao_pack_protect_string("Visitante"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'aluno';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'servidor';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'terceirizado';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'visitante';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_paciente']['valList'][$i] = form_paciente_atualizacao_pack_protect_string($v);
          }
   ...
   function ajax_return_values_flag($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_paciente)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opcao'] = '';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_paciente_atualizacao' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_paciente_atualizacao']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->visitante = $this->visitante_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total']);
              }

              $this->sc_evento = "insert"; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['parms'] = "id_paciente?#?$this->id_paciente?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter_form'];
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['select'] = ""; 
              } 
          } 
          ...
          { 
              ...
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_paciente_atualizacao_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_paciente_atualizacao = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['total'] = $qt_geral_reg_form_paciente_atualizacao;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_paciente_atualizacao_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_paciente_atualizacao_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_paciente_atualizacao_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['masterValue'] as $cmp_master => $val_master)
{
?>
