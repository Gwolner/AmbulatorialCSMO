...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate login
  function do_ajax_control_login_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_login_validate_login(var_login, var_script_case_init, do_ajax_control_login_validate_login_cb);
  } // do_ajax_control_login_validate_login

  function do_ajax_control_login_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_login_validate_login_cb
  ...
  function do_ajax_control_login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_control_login_submit_form(var_login, var_senha, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_login_submit_form_cb);
