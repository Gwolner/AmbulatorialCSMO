...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sistema_csmo_gwolner_____grid_atendimento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sistema_csmo_gwolner_____grid_atendimento"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atendimento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_atendimento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atendimento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_atendimento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_atendimento']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_atendimento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_atendimento']['embutida_filho'] as $ind => $sc_init)
          {
