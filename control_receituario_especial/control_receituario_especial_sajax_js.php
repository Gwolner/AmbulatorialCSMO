  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_receituario_especial" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome
  function do_ajax_control_receituario_especial_validate_nome()
  {
  } // do_ajax_control_receituario_especial_validate_nome

  function do_ajax_control_receituario_especial_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_receituario_especial_validate_nome_cb

  // ---------- Validate endereco
  function do_ajax_control_receituario_especial_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_receituario_especial_validate_endereco(var_endereco, var_script_case_init, do_ajax_control_receituario_especial_validate_endereco_cb);
  } // do_ajax_control_receituario_especial_validate_endereco

  function do_ajax_control_receituario_especial_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_receituario_especial_validate_endereco_cb

  // ---------- Validate prescricao
  function do_ajax_control_receituario_especial_validate_prescricao()
  {
    var nomeCampo_prescricao = "prescricao";
    var var_prescricao = scAjaxGetFieldText(nomeCampo_prescricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_receituario_especial_validate_prescricao(var_prescricao, var_script_case_init, do_ajax_control_receituario_especial_validate_prescricao_cb);
  } // do_ajax_control_receituario_especial_validate_prescricao

  function do_ajax_control_receituario_especial_validate_prescricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_receituario_especial_validate_prescricao_cb

  // ---------- Validate data
  function do_ajax_control_receituario_especial_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_receituario_especial_validate_data(var_data, var_script_case_init, do_ajax_control_receituario_especial_validate_data_cb);
  } // do_ajax_control_receituario_especial_validate_data

  function do_ajax_control_receituario_especial_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "data";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_receituario_especial_validate_data_cb
  // ---------- Form
  function do_ajax_control_receituario_especial_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_receituario_especial_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_receituario_especial_submit_form(var_nome, var_endereco, var_prescricao, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_receituario_especial_submit_form_cb);
  } // do_ajax_control_receituario_especial_submit_form

  function do_ajax_control_receituario_especial_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_receituario_especial_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_receituario_especial_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_receituario_especial_navigate_form

  function do_ajax_control_receituario_especial_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_receituario_especial_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_receituario_especial_navigate_form_cb
  function sc_hide_control_receituario_especial_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_receituario_especial_form
