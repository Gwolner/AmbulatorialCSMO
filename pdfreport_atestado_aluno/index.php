...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['pdfreport_atestado_aluno']['glo_nm_conexao'], $this->root . $this->path_prod, 'sistema_csmo_gwolner'); 
      } 
      else 
      { 
