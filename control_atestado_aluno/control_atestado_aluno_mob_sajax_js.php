  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_atestado_aluno_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome
  function do_ajax_control_atestado_aluno_mob_validate_nome()
  {
  } // do_ajax_control_atestado_aluno_mob_validate_nome

  function do_ajax_control_atestado_aluno_mob_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_atestado_aluno_mob_validate_nome_cb

  // ---------- Validate data_inicial
  function do_ajax_control_atestado_aluno_mob_validate_data_inicial()
  {
    var nomeCampo_data_inicial = "data_inicial";
    var var_data_inicial = scAjaxGetFieldText(nomeCampo_data_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_atestado_aluno_mob_validate_data_inicial(var_data_inicial, var_script_case_init, do_ajax_control_atestado_aluno_mob_validate_data_inicial_cb);
  } // do_ajax_control_atestado_aluno_mob_validate_data_inicial

  function do_ajax_control_atestado_aluno_mob_validate_data_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_atestado_aluno_mob_validate_data_inicial_cb

  // ---------- Validate data_final
  function do_ajax_control_atestado_aluno_mob_validate_data_final()
  {
    var nomeCampo_data_final = "data_final";
    var var_data_final = scAjaxGetFieldText(nomeCampo_data_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_atestado_aluno_mob_validate_data_final(var_data_final, var_script_case_init, do_ajax_control_atestado_aluno_mob_validate_data_final_cb);
  } // do_ajax_control_atestado_aluno_mob_validate_data_final

  function do_ajax_control_atestado_aluno_mob_validate_data_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_atestado_aluno_mob_validate_data_final_cb

  // ---------- Validate data
  function do_ajax_control_atestado_aluno_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_atestado_aluno_mob_validate_data(var_data, var_script_case_init, do_ajax_control_atestado_aluno_mob_validate_data_cb);
  } // do_ajax_control_atestado_aluno_mob_validate_data

  function do_ajax_control_atestado_aluno_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "data";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_atestado_aluno_mob_validate_data_cb
  // ---------- Form
  function do_ajax_control_atestado_aluno_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_atestado_aluno_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_atestado_aluno_mob_submit_form(var_nome, var_data_inicial, var_data_final, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_atestado_aluno_mob_submit_form_cb);
  } // do_ajax_control_atestado_aluno_mob_submit_form

  function do_ajax_control_atestado_aluno_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_atestado_aluno_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_atestado_aluno_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_atestado_aluno_mob_navigate_form

  function do_ajax_control_atestado_aluno_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_atestado_aluno_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_atestado_aluno_mob_navigate_form_cb
  function sc_hide_control_atestado_aluno_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_atestado_aluno_mob_form
  ...
  ajax_field_list[1] = "data_inicial";
  ajax_field_list[2] = "data_final";
  ajax_field_list[3] = "data";
  ...
  var ajax_error_list = {
    ...
    "data_inicial": {"label": "Afastado de", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
