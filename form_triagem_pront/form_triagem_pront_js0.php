<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_triagem_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_triagem_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_triagem_pront"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_triagem_pront_submit_form(y, z); 
} 
<?php
}
?>
