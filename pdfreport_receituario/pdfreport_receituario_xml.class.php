...
class pdfreport_receituario_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_receituario_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "pdfreport_receituario.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<pdfreport_receituario";
...
$_SESSION['scriptcase']['pdfreport_receituario']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->senha))
         {
             $this->senha = sc_convert_encoding($this->senha, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " senha =\"" . $this->trata_dados($this->senha) . "\"";
   }
   //----- id_servidor_saude
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
