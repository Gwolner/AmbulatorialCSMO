...
$old_error_handler = set_error_handler("control_odontograma_scriptcase_error_handler");

function control_odontograma_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_odontograma']['contr_erro']) && $_SESSION['scriptcase']['control_odontograma']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_odontograma->contr_control_odontograma->Apl_com_erro = true;
            if ($inicial_control_odontograma->contr_control_odontograma->NM_ajax_flag)
            {
                $inicial_control_odontograma->contr_control_odontograma->NM_ajax_info['errList']['geral_control_odontograma'][] = $msg;
                return;
            }
            control_odontograma_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_odontograma_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_odontograma'])  && '' != $_SESSION['scriptcase']['error_icon']['control_odontograma'])  ? $_SESSION['scriptcase']['error_icon']['control_odontograma']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_odontograma']) && '' != $_SESSION['scriptcase']['error_span_title']['control_odontograma']) ? $_SESSION['scriptcase']['error_span_title']['control_odontograma'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_odontograma']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_odontograma']) ? $_SESSION['scriptcase']['error_icon_title']['control_odontograma'] : '';
?>
