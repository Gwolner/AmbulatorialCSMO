...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['contr_label_graf']['tipo_servico']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['contr_label_graf']['tipo_servico']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['contr_label_graf']['tipo_servico'];
      }
   }
