...
class pdfreport_atestado_aluno_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_atestado_aluno_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo    .= "_pdfreport_atestado_aluno";
      $this->Arquivo    .= ".csv";
      $this->Tit_doc    = "pdfreport_atestado_aluno.csv";
      $this->Delim_dados = "\"";
      $this->Delim_col   = ";";
      $this->Delim_line  = "\r\n";
   }
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['csv_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['order_grid'];
...
if($data_final_aux == ""){
	...
	$this->data_final  = $data_final_aux;
};
...
$this->data_inicial  = $data_inicial_aux;
$this->dia  = $this->dia;
$this->mes  = $this->mes;
$this->ano  = $this->ano;
...
$_SESSION['scriptcase']['pdfreport_atestado_aluno']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['field_order'] as $Cada_col)
         { 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno'][$path_doc_md5][1] = $this->Tit_doc;
?>
