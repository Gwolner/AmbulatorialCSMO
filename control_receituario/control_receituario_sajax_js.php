  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_receituario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate data
  function do_ajax_control_receituario_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_receituario_validate_data(var_data, var_script_case_init, do_ajax_control_receituario_validate_data_cb);
  } // do_ajax_control_receituario_validate_data

  function do_ajax_control_receituario_validate_data_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_receituario_validate_data_cb

  // ---------- Validate texto
  function do_ajax_control_receituario_validate_texto()
  {
    var nomeCampo_texto = "texto";
    var var_texto = scAjaxGetFieldText(nomeCampo_texto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_receituario_validate_texto(var_texto, var_script_case_init, do_ajax_control_receituario_validate_texto_cb);
  } // do_ajax_control_receituario_validate_texto

  function do_ajax_control_receituario_validate_texto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "texto";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_receituario_validate_texto_cb
  // ---------- Form
  function do_ajax_control_receituario_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_receituario_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_receituario_submit_form(var_data, var_texto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_receituario_submit_form_cb);
  } // do_ajax_control_receituario_submit_form

  function do_ajax_control_receituario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_receituario_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_receituario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_receituario_navigate_form

  function do_ajax_control_receituario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_receituario_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_receituario_navigate_form_cb
  function sc_hide_control_receituario_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_receituario_form
