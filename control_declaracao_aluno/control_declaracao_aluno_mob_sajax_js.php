  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_declaracao_aluno_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome
  function do_ajax_control_declaracao_aluno_mob_validate_nome()
  {
  } // do_ajax_control_declaracao_aluno_mob_validate_nome

  function do_ajax_control_declaracao_aluno_mob_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_declaracao_aluno_mob_validate_nome_cb

  // ---------- Validate de
  function do_ajax_control_declaracao_aluno_mob_validate_de()
  {
    var nomeCampo_de = "de";
    var var_de = scAjaxGetFieldText(nomeCampo_de);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_declaracao_aluno_mob_validate_de(var_de, var_script_case_init, do_ajax_control_declaracao_aluno_mob_validate_de_cb);
  } // do_ajax_control_declaracao_aluno_mob_validate_de

  function do_ajax_control_declaracao_aluno_mob_validate_de_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "de";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_declaracao_aluno_mob_validate_de_cb

  // ---------- Validate as
  function do_ajax_control_declaracao_aluno_mob_validate_as()
  {
    var nomeCampo_as = "as";
    var var_as = scAjaxGetFieldText(nomeCampo_as);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_declaracao_aluno_mob_validate_as(var_as, var_script_case_init, do_ajax_control_declaracao_aluno_mob_validate_as_cb);
  } // do_ajax_control_declaracao_aluno_mob_validate_as

  function do_ajax_control_declaracao_aluno_mob_validate_as_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "as";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_declaracao_aluno_mob_validate_as_cb

  // ---------- Validate data
  function do_ajax_control_declaracao_aluno_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_declaracao_aluno_mob_validate_data(var_data, var_script_case_init, do_ajax_control_declaracao_aluno_mob_validate_data_cb);
  } // do_ajax_control_declaracao_aluno_mob_validate_data

  function do_ajax_control_declaracao_aluno_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "data";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_declaracao_aluno_mob_validate_data_cb
  // ---------- Form
  function do_ajax_control_declaracao_aluno_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_declaracao_aluno_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome = scAjaxGetFieldText("nome");
    var var_de = scAjaxGetFieldText("de");
    var var_as = scAjaxGetFieldText("as");
    ...
    scAjaxProcOn();
    x_ajax_control_declaracao_aluno_mob_submit_form(var_nome, var_de, var_as, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_declaracao_aluno_mob_submit_form_cb);
  } // do_ajax_control_declaracao_aluno_mob_submit_form

  function do_ajax_control_declaracao_aluno_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_declaracao_aluno_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_declaracao_aluno_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_declaracao_aluno_mob_navigate_form

  function do_ajax_control_declaracao_aluno_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_declaracao_aluno_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_declaracao_aluno_mob_navigate_form_cb
  function sc_hide_control_declaracao_aluno_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_declaracao_aluno_mob_form
  ...
  ajax_field_list[1] = "de";
  ajax_field_list[2] = "as";
  ...
  var ajax_error_list = {
    ...
    "de": {"label": "Horário (de)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "as": {"label": "Às", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["de"][1] = "de";
  ajax_field_mult["as"][1] = "as";
  ajax_field_mult["data"][1] = "data";

  var ajax_field_id = {
    "nome": new Array("hidden_field_label_nome", "hidden_field_data_nome"),
    "de": new Array("hidden_field_label_de", "hidden_field_data_de"),
    "as": new Array("hidden_field_label_as", "hidden_field_data_as"),
