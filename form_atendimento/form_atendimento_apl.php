...
//----- 
   function ini_controle()
   {
      ...
      { 
          ...
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['initialize'])
          {
...
$aLookup[] = array(form_atendimento_pack_protect_string('Serviço de Enfermagem') => form_atendimento_pack_protect_string("Serviço de Enfermagem"));
$aLookup[] = array(form_atendimento_pack_protect_string('Serviço Médico') => form_atendimento_pack_protect_string("Serviço Médico"));
$aLookup[] = array(form_atendimento_pack_protect_string('Serviço Odontológico') => form_atendimento_pack_protect_string("Serviço Odontológico"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_tipo_servico'][] = 'Serviço de Enfermagem';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_tipo_servico'][] = 'Serviço Médico';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_tipo_servico'][] = 'Serviço Odontológico';
          $aLookupOrig = $aLookup;
...
$aLookup[] = array(form_atendimento_pack_protect_string('Administração de Medicamentos') => form_atendimento_pack_protect_string("Administração de Medicamentos"));
$aLookup[] = array(form_atendimento_pack_protect_string('Aferição de Pressão Arterial') => form_atendimento_pack_protect_string("Aferição de Pressão Arterial"));
$aLookup[] = array(form_atendimento_pack_protect_string('Aferição de Temperatura') => form_atendimento_pack_protect_string("Aferição de Temperatura"));
$aLookup[] = array(form_atendimento_pack_protect_string('Altura') => form_atendimento_pack_protect_string("Altura"));
$aLookup[] = array(form_atendimento_pack_protect_string('Aplicação de Insulina') => form_atendimento_pack_protect_string("Aplicação de Insulina"));
...
$aLookup[] = array(form_atendimento_pack_protect_string('Orientação') => form_atendimento_pack_protect_string("Orientação"));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_enfermagem'][] = 'Administração de Medicamentos';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_enfermagem'][] = 'Aferição de Pressão Arterial';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_enfermagem'][] = 'Aferição de Temperatura';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_enfermagem'][] = 'Altura';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_enfermagem'][] = 'Aplicação de Insulina';
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_enfermagem'][] = 'Orientação';
...
$aLookup[] = array(form_atendimento_pack_protect_string('Homologação de Atestados (Alunos)') => form_atendimento_pack_protect_string("Homologação de Atestados (Alunos)"));
$aLookup[] = array(form_atendimento_pack_protect_string('Licença Médica') => form_atendimento_pack_protect_string("Licença Médica"));
$aLookup[] = array(form_atendimento_pack_protect_string('Outros') => form_atendimento_pack_protect_string("Outros"));
$aLookup[] = array(form_atendimento_pack_protect_string('Perícia Domiciliar/Externa') => form_atendimento_pack_protect_string("Perícia Domiciliar/Externa"));
$aLookup[] = array(form_atendimento_pack_protect_string('Perícia Médica') => form_atendimento_pack_protect_string("Perícia Médica"));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_medico'][] = 'Homologação de Atestados (Alunos)';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_medico'][] = 'Licença Médica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_medico'][] = 'Outros';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_medico'][] = 'Perícia Domiciliar/Externa';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_medico'][] = 'Perícia Médica';
          $aLookupOrig = $aLookup;
...
$aLookup[] = array(form_atendimento_pack_protect_string('Consulta') => form_atendimento_pack_protect_string("Consulta"));
$aLookup[] = array(form_atendimento_pack_protect_string('Curativo Endodôntico') => form_atendimento_pack_protect_string("Curativo Endodôntico"));
...
$aLookup[] = array(form_atendimento_pack_protect_string('Flúor') => form_atendimento_pack_protect_string("Flúor"));
$aLookup[] = array(form_atendimento_pack_protect_string('Obturação Canal') => form_atendimento_pack_protect_string("Obturação Canal"));
$aLookup[] = array(form_atendimento_pack_protect_string('Orientação Higiene Oral') => form_atendimento_pack_protect_string("Orientação Higiene Oral"));
$aLookup[] = array(form_atendimento_pack_protect_string('Outros') => form_atendimento_pack_protect_string("Outros"));
$aLookup[] = array(form_atendimento_pack_protect_string('Perícia') => form_atendimento_pack_protect_string("Perícia"));
...
$aLookup[] = array(form_atendimento_pack_protect_string('Remoção de Tártaro') => form_atendimento_pack_protect_string("Remoção de Tártaro"));
$aLookup[] = array(form_atendimento_pack_protect_string('Restauração, Resina e Outros') => form_atendimento_pack_protect_string("Restauração, Resina e Outros"));
...
$aLookup[] = array(form_atendimento_pack_protect_string('Tratamento Concluído') => form_atendimento_pack_protect_string("Tratamento Concluído"));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Curativo Endodôntico';
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Flúor';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Obturação Canal';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Orientação Higiene Oral';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Outros';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Perícia';
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Remoção de Tártaro';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Restauração, Resina e Outros';
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atendimento']['Lookup_procedimento_odontologico'][] = 'Tratamento Concluído';
