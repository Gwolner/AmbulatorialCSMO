...
class pdfreport_receituario_especial_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario_especial']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_receituario_especial']['arr_export']['data'];
       $b_display = false;
