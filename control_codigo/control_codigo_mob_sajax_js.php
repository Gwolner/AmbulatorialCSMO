  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_codigo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate codigo
  function do_ajax_control_codigo_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codigo_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_control_codigo_mob_validate_codigo_cb);
  } // do_ajax_control_codigo_mob_validate_codigo

  function do_ajax_control_codigo_mob_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codigo_mob_validate_codigo_cb
  // ---------- Form
  function do_ajax_control_codigo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_codigo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigo = scAjaxGetFieldText("codigo");
    ...
    scAjaxProcOn();
    x_ajax_control_codigo_mob_submit_form(var_codigo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_codigo_mob_submit_form_cb);
  } // do_ajax_control_codigo_mob_submit_form

  function do_ajax_control_codigo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_codigo_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_codigo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_codigo_mob_navigate_form

  function do_ajax_control_codigo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_codigo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_codigo_mob_navigate_form_cb
  function sc_hide_control_codigo_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_codigo_mob_form
  ...
  ajax_field_list[0] = "codigo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "codigo": {"label": "Codigo de Alteração da Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
