  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_prontuario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_control_prontuario_validate_nome_paciente()
  {
  } // do_ajax_control_prontuario_validate_nome_paciente

  function do_ajax_control_prontuario_validate_nome_paciente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_prontuario_validate_nome_paciente_cb

  // ---------- Validate data_nascimento
  function do_ajax_control_prontuario_validate_data_nascimento()
  {
    ...
    x_ajax_control_prontuario_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_control_prontuario_validate_data_nascimento_cb);
  } // do_ajax_control_prontuario_validate_data_nascimento

  function do_ajax_control_prontuario_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_prontuario_validate_data_nascimento_cb

  // ---------- Validate cpf
  function do_ajax_control_prontuario_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldHidden(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_prontuario_validate_cpf(var_cpf, var_script_case_init, do_ajax_control_prontuario_validate_cpf_cb);
  } // do_ajax_control_prontuario_validate_cpf

  function do_ajax_control_prontuario_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_prontuario_validate_cpf_cb

  // ---------- Event onchange nome_paciente
  function do_ajax_control_prontuario_event_nome_paciente_onchange()
  {
    ...
    x_ajax_control_prontuario_event_nome_paciente_onchange(var_nome_paciente, var_data_nascimento, var_cpf, var_script_case_init, do_ajax_control_prontuario_event_nome_paciente_onchange_cb);
  } // do_ajax_control_prontuario_event_nome_paciente_onchange

  function do_ajax_control_prontuario_event_nome_paciente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome_paciente";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_prontuario_event_nome_paciente_onchange_cb
  // ---------- Form
  function do_ajax_control_prontuario_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_prontuario_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome_paciente = scAjaxGetFieldText("nome_paciente");
    ...
    scAjaxProcOn();
    x_ajax_control_prontuario_submit_form(var_nome_paciente, var_data_nascimento, var_cpf, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_prontuario_submit_form_cb);
  } // do_ajax_control_prontuario_submit_form

  function do_ajax_control_prontuario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_prontuario_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_prontuario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_prontuario_navigate_form

  function do_ajax_control_prontuario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_prontuario_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_prontuario_navigate_form_cb
  function sc_hide_control_prontuario_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_prontuario_form
