  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_servidor_saude" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_control_servidor_saude_validate_botao_opcao()
  {
    var nomeCampo_botao_opcao = "botao_opcao";
    var var_botao_opcao = scAjaxGetFieldRadio(nomeCampo_botao_opcao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_servidor_saude_validate_botao_opcao(var_botao_opcao, var_script_case_init, do_ajax_control_servidor_saude_validate_botao_opcao_cb);
  } // do_ajax_control_servidor_saude_validate_botao_opcao

  function do_ajax_control_servidor_saude_validate_botao_opcao_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_servidor_saude_validate_botao_opcao_cb

  // ---------- Validate siape
  function do_ajax_control_servidor_saude_validate_siape()
  {
  } // do_ajax_control_servidor_saude_validate_siape

  function do_ajax_control_servidor_saude_validate_siape_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "siape";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_servidor_saude_validate_siape_cb

  // ---------- Validate nome
  function do_ajax_control_servidor_saude_validate_nome()
  {
  } // do_ajax_control_servidor_saude_validate_nome

  function do_ajax_control_servidor_saude_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_servidor_saude_validate_nome_cb

  // ---------- Event onclick botao_opcao
  function do_ajax_control_servidor_saude_event_botao_opcao_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_servidor_saude_event_botao_opcao_onclick(var_botao_opcao, var_siape, var_nome, var_script_case_init, do_ajax_control_servidor_saude_event_botao_opcao_onclick_cb);
  } // do_ajax_control_servidor_saude_event_botao_opcao_onclick

  function do_ajax_control_servidor_saude_event_botao_opcao_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "botao_opcao";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_servidor_saude_event_botao_opcao_onclick_cb
  // ---------- Form
  function do_ajax_control_servidor_saude_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_servidor_saude_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_botao_opcao = scAjaxGetFieldRadio("botao_opcao");
    ...
    scAjaxProcOn();
    x_ajax_control_servidor_saude_submit_form(var_botao_opcao, var_siape, var_nome, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_servidor_saude_submit_form_cb);
  } // do_ajax_control_servidor_saude_submit_form

  function do_ajax_control_servidor_saude_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_servidor_saude_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_servidor_saude_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_servidor_saude_navigate_form

  function do_ajax_control_servidor_saude_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_servidor_saude_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_servidor_saude_navigate_form_cb
  function sc_hide_control_servidor_saude_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_servidor_saude_form
