...
$old_error_handler = set_error_handler("control_atualizar_senha_scriptcase_error_handler");

function control_atualizar_senha_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_atualizar_senha']['contr_erro']) && $_SESSION['scriptcase']['control_atualizar_senha']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_atualizar_senha->contr_control_atualizar_senha->Apl_com_erro = true;
            if ($inicial_control_atualizar_senha->contr_control_atualizar_senha->NM_ajax_flag)
            {
                $inicial_control_atualizar_senha->contr_control_atualizar_senha->NM_ajax_info['errList']['geral_control_atualizar_senha'][] = $msg;
                return;
            }
            control_atualizar_senha_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_atualizar_senha_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_atualizar_senha'])  && '' != $_SESSION['scriptcase']['error_icon']['control_atualizar_senha'])  ? $_SESSION['scriptcase']['error_icon']['control_atualizar_senha']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_atualizar_senha']) && '' != $_SESSION['scriptcase']['error_span_title']['control_atualizar_senha']) ? $_SESSION['scriptcase']['error_span_title']['control_atualizar_senha'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_atualizar_senha']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_atualizar_senha']) ? $_SESSION['scriptcase']['error_icon_title']['control_atualizar_senha'] : '';
?>
