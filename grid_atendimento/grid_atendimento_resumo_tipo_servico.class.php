...
class grid_atendimento_resumo
{
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels']['tipo_servico'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels']['procedimento'] = "Procedimento"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels']['tipo_paciente'] = "Tipo Paciente"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atendimento']['labels']['data_hora'] = "Data Hora"; 
       ...
       //-----
       foreach ($this->array_total_tipo_servico as $i_tipo_servico => $d_tipo_servico) {
           if (!in_array($i_tipo_servico, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tipo_servico[2] ] = $d_tipo_servico[1];
               $this->comp_label[0][ $d_tipo_servico[2] ] = $d_tipo_servico[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'tipo_servico', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tipo_servico => $l_tipo_servico) {
           if (isset($this->array_total_tipo_servico[$i_tipo_servico])) {
               $this->comp_group[$i_tipo_servico] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_tipo_servico;
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_tipo_servico("res", $this->array_total_tipo_servico);
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_tipo_servico, $quebra_tipo_servico_orig)
   {
      //----- 
      if (!isset($this->array_total_tipo_servico[$quebra_tipo_servico_orig]))
      {
         $this->array_total_tipo_servico[$quebra_tipo_servico_orig][0] = 1;
         $this->array_total_tipo_servico[$quebra_tipo_servico_orig][1] = $quebra_tipo_servico;
         $this->array_total_tipo_servico[$quebra_tipo_servico_orig][2] = $quebra_tipo_servico_orig;
      }
      else
      {
         $this->array_total_tipo_servico[$quebra_tipo_servico_orig][0]++;
      }
   }
...
$_SESSION['scriptcase']['grid_atendimento']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tipo_servico, $this->tipo_servico_orig);
            }
   }
//
