<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_atendimento_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_atendimento_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['procedimento'] = "on";
   $tab_def_campos['procedimento'] = "procedimento";
   $tab_converte["procedimento"]   = "procedimento";
   $tab_labels["procedimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["procedimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["procedimento"] : "Procedimento";
   $tab_ger_campos['aluno'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['aluno'] = "aluno";
       $tab_converte["aluno"]   = "aluno";
   }
   else
   {
       $tab_def_campos['aluno'] = "";
       $tab_converte[""]   = "aluno";
   }
   $tab_labels["aluno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["aluno"])) ? $_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["aluno"] : "Aluno";
   $tab_ger_campos['servidor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['servidor'] = "servidor";
       $tab_converte["servidor"]   = "servidor";
   }
   else
   {
       $tab_def_campos['servidor'] = "";
       $tab_converte[""]   = "servidor";
   }
   $tab_labels["servidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["servidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["servidor"] : "Servidor";
   $tab_ger_campos['servidor_terceirizado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['servidor_terceirizado'] = "servidor_terceirizado";
       $tab_converte["servidor_terceirizado"]   = "servidor_terceirizado";
   }
   else
   {
       $tab_def_campos['servidor_terceirizado'] = "";
       $tab_converte[""]   = "servidor_terceirizado";
   }
   $tab_labels["servidor_terceirizado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["servidor_terceirizado"])) ? $_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["servidor_terceirizado"] : "Servidor Terceirizado";
   $tab_ger_campos['visitante'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['visitante'] = "visitante";
       $tab_converte["visitante"]   = "visitante";
   }
   else
   {
       $tab_def_campos['visitante'] = "";
       $tab_converte[""]   = "visitante";
   }
   $tab_labels["visitante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["visitante"])) ? $_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["visitante"] : "Visitante";
   $tab_ger_campos['total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['total'] = "total";
       $tab_converte["total"]   = "total";
   }
   else
   {
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_atendimento']['labels']["total"] : "Total";
   $tab_ger_campos['aluno'] = "none";
   $tab_ger_campos['servidor'] = "none";
   $tab_ger_campos['servidor_terceirizado'] = "none";
   $tab_ger_campos['visitante'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_atendimento']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_atendimento']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_atendimento_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_atendimento']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
