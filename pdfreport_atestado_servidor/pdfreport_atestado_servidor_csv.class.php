...
class pdfreport_atestado_servidor_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_atestado_servidor_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo    .= ".csv";
      $this->Tit_doc    = "pdfreport_atestado_servidor.csv";
      $this->Delim_dados = "\"";
      $this->Delim_col   = ";";
      $this->Delim_line  = "\r\n";
   }
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['csv_name']);
      }
...
$_SESSION['scriptcase']['pdfreport_atestado_servidor']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_servidor']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
