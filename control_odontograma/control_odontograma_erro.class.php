...
class control_odontograma_erro
{
   var $Ini;
   ...
   //----- 
   function control_odontograma_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return control_odontograma_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
