...
class pdfreport_atestado_aptidao_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_atestado_aptidao_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "pdfreport_atestado_aptidao.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<pdfreport_atestado_aptidao";
...
$_SESSION['scriptcase']['pdfreport_atestado_aptidao']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->apto))
         {
             $this->apto = sc_convert_encoding($this->apto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " apto =\"" . $this->trata_dados($this->apto) . "\"";
   }
   //----- inapto
   function NM_export_inapto()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->inapto))
         {
             $this->inapto = sc_convert_encoding($this->inapto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " inapto =\"" . $this->trata_dados($this->inapto) . "\"";
   }
   //----- modalidade
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
