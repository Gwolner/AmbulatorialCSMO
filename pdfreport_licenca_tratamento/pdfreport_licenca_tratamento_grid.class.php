<?php
class pdfreport_licenca_tratamento_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_licenca_tratamento']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_licenca_tratamento", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_licenca_tratamento']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_licenca_tratamento']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_licenca_tratamento']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_licenca_tratamento']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['id_paciente'] = "Id Paciente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['nome'] = "nome";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['cpf'] = "cpf";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['orgao'] = "orgao";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['siape'] = "siape";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['data_inicial'] = "data_inicial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['data_final'] = "data_final";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['numero_de_dias'] = "numero_de_dias";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['dia_hoje'] = "dia_hoje";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['mes_hoje'] = "mes_hoje";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['ano_hoje'] = "ano_hoje";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['labels']['cid'] = "cid";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_licenca_tratamento']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_licenca_tratamento']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_licenca_tratamento']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento']['qt_col_grid']) 
      {  
...
$_SESSION['scriptcase']['pdfreport_licenca_tratamento']['contr_erro'] = 'off';
          ...
          $this->cid[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->cid[$this->nm_grid_colunas]);
            ...
            $cell_data_inicial = array('posx' => 129, 'posy' => 153, 'data' => $this->data_inicial[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_data_final = array('posx' => 20, 'posy' => 158, 'data' => $this->data_final[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_numero_de_dias = array('posx' => 138, 'posy' => 164, 'data' => $this->numero_de_dias[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_dia_hoje = array('posx' => 34, 'posy' => 206, 'data' => $this->dia_hoje[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_mes_hoje = array('posx' => 56, 'posy' => 206, 'data' => $this->mes_hoje[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_ano_hoje = array('posx' => 93, 'posy' => 206, 'data' => $this->ano_hoje[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_cid = array('posx' => 28, 'posy' => 198, 'data' => $this->cid[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
