...
function sc_btn_sc_btn_0()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_control_email_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?"; ?>', '', '_self', '0', '0', 'control_email');
}
 NM_tp_critica(1);
