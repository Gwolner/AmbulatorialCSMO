<?php
class pdfreport_declaracao_aluno_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_declaracao_aluno']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_declaracao_aluno", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_declaracao_aluno']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_declaracao_aluno']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_declaracao_aluno']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_declaracao_aluno']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['id_usuario'] = "Id Usuario";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['de'] = "de";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['as'] = "as";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['nome_parte1'] = "nome_parte1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['nome_parte2'] = "nome_parte2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['dia'] = "dia";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['mes'] = "mes";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['labels']['ano'] = "ano";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_declaracao_aluno']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_declaracao_aluno']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_declaracao_aluno']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_declaracao_aluno']['qt_col_grid']) 
      {  
          ...
          $this->de[$this->nm_grid_colunas] = "";
          $this->as[$this->nm_grid_colunas] = "";
...
$this->de[$this->nm_grid_colunas]  = $hora_de.":".$min_de;
$this->as[$this->nm_grid_colunas]  = $hora_as.":".$min_as;
...
$_SESSION['scriptcase']['pdfreport_declaracao_aluno']['contr_erro'] = 'off';
          ...
          if ($this->de[$this->nm_grid_colunas] === "") 
          { 
              $this->de[$this->nm_grid_colunas] = "" ;  
          } 
          $this->de[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->de[$this->nm_grid_colunas]);
          if ($this->as[$this->nm_grid_colunas] === "") 
          { 
              $this->as[$this->nm_grid_colunas] = "" ;  
          } 
          $this->as[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->as[$this->nm_grid_colunas]);
          ...
          $this->ano[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->ano[$this->nm_grid_colunas]);
            ...
            $cell_de = array('posx' => 84, 'posy' => 95, 'data' => $this->de[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_as = array('posx' => 98, 'posy' => 95, 'data' => $this->as[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $this->Pdf->SetFont($cell_de['font_type'], $cell_de['font_style'], $cell_de['font_size']);
            $this->pdf_text_color($cell_de['data'], $cell_de['color_r'], $cell_de['color_g'], $cell_de['color_b']);
            if (!empty($cell_de['posx']) && !empty($cell_de['posy']))
            {
                $this->Pdf->SetXY($cell_de['posx'], $cell_de['posy']);
            }
            elseif (!empty($cell_de['posx']))
            {
                $this->Pdf->SetX($cell_de['posx']);
            }
            elseif (!empty($cell_de['posy']))
            {
                $this->Pdf->SetY($cell_de['posy']);
            }
            $this->Pdf->Cell($cell_de['width'], 0, $cell_de['data'], 0, 0, $cell_de['align']);

            $this->Pdf->SetFont($cell_as['font_type'], $cell_as['font_style'], $cell_as['font_size']);
            $this->pdf_text_color($cell_as['data'], $cell_as['color_r'], $cell_as['color_g'], $cell_as['color_b']);
            if (!empty($cell_as['posx']) && !empty($cell_as['posy']))
            {
                $this->Pdf->SetXY($cell_as['posx'], $cell_as['posy']);
            }
            elseif (!empty($cell_as['posx']))
            {
                $this->Pdf->SetX($cell_as['posx']);
            }
            elseif (!empty($cell_as['posy']))
            {
                $this->Pdf->SetY($cell_as['posy']);
            }
            $this->Pdf->Cell($cell_as['width'], 0, $cell_as['data'], 0, 0, $cell_as['align']);
