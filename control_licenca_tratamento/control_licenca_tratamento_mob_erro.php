...
$old_error_handler = set_error_handler("control_licenca_tratamento_mob_scriptcase_error_handler");

function control_licenca_tratamento_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_licenca_tratamento_mob']['contr_erro']) && $_SESSION['scriptcase']['control_licenca_tratamento_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_licenca_tratamento_mob->contr_control_licenca_tratamento_mob->Apl_com_erro = true;
            if ($inicial_control_licenca_tratamento_mob->contr_control_licenca_tratamento_mob->NM_ajax_flag)
            {
                $inicial_control_licenca_tratamento_mob->contr_control_licenca_tratamento_mob->NM_ajax_info['errList']['geral_control_licenca_tratamento_mob'][] = $msg;
                return;
            }
            control_licenca_tratamento_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_licenca_tratamento_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_licenca_tratamento_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['control_licenca_tratamento_mob'])  ? $_SESSION['scriptcase']['error_icon']['control_licenca_tratamento_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_licenca_tratamento_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['control_licenca_tratamento_mob']) ? $_SESSION['scriptcase']['error_span_title']['control_licenca_tratamento_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_licenca_tratamento_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_licenca_tratamento_mob']) ? $_SESSION['scriptcase']['error_icon_title']['control_licenca_tratamento_mob'] : '';
?>
