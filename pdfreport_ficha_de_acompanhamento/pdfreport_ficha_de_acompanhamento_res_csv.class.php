...
class pdfreport_ficha_de_acompanhamento_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_ficha_de_acompanhamento_csv()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".csv";
      $this->Tit_doc    = "pdfreport_ficha_de_acompanhamento.csv";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['csv_name']);
      }
      $this->Res           = new pdfreport_ficha_de_acompanhamento_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['arr_export']['data'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['pivot_tabular'];
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ficha_de_acompanhamento']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
