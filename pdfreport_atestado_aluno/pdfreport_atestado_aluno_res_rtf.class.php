...
class pdfreport_atestado_aluno_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   //---- 
   function pdfreport_atestado_aluno_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_atestado_aluno.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['arr_export']['data'];
       $b_display = false;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aluno']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
