...
class pdfreport_licenca_tratamento_familiar_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_licenca_tratamento_familiar_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".xml";
      $this->Tit_doc       = "pdfreport_licenca_tratamento_familiar.xml";
      $this->Grava_view   = false;
      if (strtolower($_SESSION['scriptcase']['charset']) != strtolower($_SESSION['scriptcase']['charset_html']))
      {
          $this->Grava_view = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['xml_name']);
      }
      if (!$this->Grava_view)
      {
          $this->Arquivo_view = $this->Arquivo;
      }
      $this->Res       = new pdfreport_licenca_tratamento_familiar_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['arr_export']['data'];
      $contr_rowspan = array();
      $tit_rowspan   = array();
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          $lab           = "";
          $cmp           = false;
          $xml_registro  = "<pdfreport_licenca_tratamento_familiar";
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
              {
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_licenca_tratamento_familiar']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
