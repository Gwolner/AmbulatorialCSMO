  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_visitante_pront_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate rg
  function do_ajax_form_visitante_pront_mob_validate_rg()
  {
    var nomeCampo_rg = "rg";
    var var_rg = scAjaxGetFieldText(nomeCampo_rg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visitante_pront_mob_validate_rg(var_rg, var_script_case_init, do_ajax_form_visitante_pront_mob_validate_rg_cb);
  } // do_ajax_form_visitante_pront_mob_validate_rg

  function do_ajax_form_visitante_pront_mob_validate_rg_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visitante_pront_mob_validate_rg_cb

  // ---------- Validate orgao_expedidor
  function do_ajax_form_visitante_pront_mob_validate_orgao_expedidor()
  {
    var nomeCampo_orgao_expedidor = "orgao_expedidor";
    var var_orgao_expedidor = scAjaxGetFieldText(nomeCampo_orgao_expedidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visitante_pront_mob_validate_orgao_expedidor(var_orgao_expedidor, var_script_case_init, do_ajax_form_visitante_pront_mob_validate_orgao_expedidor_cb);
  } // do_ajax_form_visitante_pront_mob_validate_orgao_expedidor

  function do_ajax_form_visitante_pront_mob_validate_orgao_expedidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visitante_pront_mob_validate_orgao_expedidor_cb

  // ---------- Validate data_cadastro
  function do_ajax_form_visitante_pront_mob_validate_data_cadastro()
  {
    var nomeCampo_data_cadastro = "data_cadastro";
    var var_data_cadastro = scAjaxGetFieldText(nomeCampo_data_cadastro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visitante_pront_mob_validate_data_cadastro(var_data_cadastro, var_script_case_init, do_ajax_form_visitante_pront_mob_validate_data_cadastro_cb);
  } // do_ajax_form_visitante_pront_mob_validate_data_cadastro

  function do_ajax_form_visitante_pront_mob_validate_data_cadastro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visitante_pront_mob_validate_data_cadastro_cb
  // ---------- Form
  function do_ajax_form_visitante_pront_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_visitante_pront_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_visitante_pront_mob_submit_form(var_rg, var_orgao_expedidor, var_data_cadastro, var_id_visitante, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_visitante_pront_mob_submit_form_cb);
  } // do_ajax_form_visitante_pront_mob_submit_form

  function do_ajax_form_visitante_pront_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_visitante_pront_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_visitante_pront_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_visitante_pront_mob_navigate_form(var_id_visitante, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_visitante_pront_mob_navigate_form_cb);
  } // do_ajax_form_visitante_pront_mob_navigate_form

  function do_ajax_form_visitante_pront_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_visitante_pront_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_visitante_pront_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_visitante_pront_mob_navigate_form_cb
  function sc_hide_form_visitante_pront_mob_form()
  {
