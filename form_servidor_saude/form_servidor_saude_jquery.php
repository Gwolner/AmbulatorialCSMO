...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_data_cadastro_hora' + iSeqRow).bind('blur', function() { sc_form_servidor_saude_data_cadastro_hora_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_servidor_saude_data_cadastro_hora_onfocus(this, iSeqRow) });
...
function sc_form_servidor_saude_data_cadastro_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_servidor_saude_validate_data_cadastro();
  scCssBlur(oThis);
}
...
function sc_form_servidor_saude_data_cadastro_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
