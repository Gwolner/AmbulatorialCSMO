...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_envio']['glo_nm_conexao'], $this->root . $this->path_prod, 'sistema_csmo_gwolner'); 
      } 
      else 
      { 
...
if (!isset($this->sc_temp_flag1)) {$this->sc_temp_flag1 = (isset($_SESSION['flag1'])) ? $_SESSION['flag1'] : "";}
 if($this->sc_temp_flag1 == true){
	...
	$mail_subject        = "Código de Recuperação da Senha - CSMO";            
