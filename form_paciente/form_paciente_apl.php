...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_paciente']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_paciente']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_paciente']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_paciente']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_paciente']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_paciente']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_paciente']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_paciente']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_paciente']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_paciente']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_paciente']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_paciente']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_paciente']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_paciente_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['initialize'])
          {
...
$_SESSION['scriptcase']['form_paciente']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_paciente']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_paciente']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_paciente'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_paciente']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_paciente']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_paciente') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_paciente']['label'] = "Atualizar dados do Paciente";
      ...
      $_SESSION['scriptcase']['error_icon']['form_paciente']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_paciente'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_paciente']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_paciente", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_paciente/form_paciente_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_paciente_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_paciente_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_paciente_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_paciente/form_paciente_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_paciente_erro.class.php"); 
      }
      $this->Erro      = new form_paciente_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao']))
         { 
             if ($this->id_paciente != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_paciente']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_paciente']) || !is_array($this->NM_ajax_info['errList']['geral_form_paciente']))
              {
                  $this->NM_ajax_info['errList']['geral_form_paciente'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_paciente'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
$_SESSION['scriptcase']['form_paciente']['contr_erro'] = 'off'; 
    ...
    function ValidateField_data_nascimento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_data_nascimento' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['php_cmp_required']['data_nascimento'] == "on")) 
           { 
    ...
    function ValidateField_flag(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->flag, 3, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Flag; " ; 
                  if (!isset($Campos_Erros['flag']))
                  {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_paciente']['keyVal'] = form_paciente_pack_protect_string($this->nmgp_dados_form['id_paciente']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_paciente_pack_protect_string('aluno') => form_paciente_pack_protect_string("Aluno"));
$aLookup[] = array(form_paciente_pack_protect_string('servidor') => form_paciente_pack_protect_string("Servidor"));
$aLookup[] = array(form_paciente_pack_protect_string('terceirizado') => form_paciente_pack_protect_string("Terceirizado"));
$aLookup[] = array(form_paciente_pack_protect_string('visitante') => form_paciente_pack_protect_string("Visitante"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['Lookup_tipo_paciente'][] = 'aluno';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['Lookup_tipo_paciente'][] = 'servidor';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['Lookup_tipo_paciente'][] = 'terceirizado';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['Lookup_tipo_paciente'][] = 'visitante';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_paciente']['valList'][$i] = form_paciente_pack_protect_string($v);
          }
   ...
   function ajax_return_values_flag($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_paciente)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] = '';
...
if($this->verifica_cpf ){
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_paciente' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_paciente']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->telefone_contato = $this->telefone_contato_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total']);
              }

              $this->sc_evento = "insert"; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['form_paciente']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['parms'] = "id_paciente?#?$this->id_paciente?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_filter_form'];
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_paciente_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_paciente = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['total'] = $qt_geral_reg_form_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_paciente_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_paciente_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_paciente_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['masterValue']))
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente']['retorno_edit'] = "";
   }
