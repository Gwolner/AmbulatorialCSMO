...
class form_prontuario_backup_erro
{
   var $Ini;
   ...
   //----- 
   function form_prontuario_backup_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return form_prontuario_backup_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
