...
class pdfreport_atestado_aptidao_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_atestado_aptidao_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_pdfreport_atestado_aptidao";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_atestado_aptidao.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['order_grid'];
      ...
      $this->Texto_tag .= "<tr>\r\n";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['field_order'] as $Cada_col)
      { 
          ...
          $SC_Label = (isset($this->New_label['apto'])) ? $this->New_label['apto'] : "Apto"; 
          if ($Cada_col == "apto" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          $SC_Label = (isset($this->New_label['inapto'])) ? $this->New_label['inapto'] : "Inapto"; 
          if ($Cada_col == "inapto" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$this->mes  = $this->mes;
$this->ano  = $this->ano;
$this->modalidade  = $modalidade_aux;
...
$_SESSION['scriptcase']['pdfreport_atestado_aptidao']['contr_erro'] = 'off'; 
   ...
   function NM_export_numer_de_dias()
   {
         ...
         $this->numer_de_dias = str_replace('<', '&lt;', $this->numer_de_dias);
         $this->numer_de_dias = str_replace('>', '&gt;', $this->numer_de_dias);
         $this->Texto_tag .= "<td>" . $this->numer_de_dias . "</td>\r\n";
   }
   //----- apto
   function NM_export_apto()
   {
         $this->apto = html_entity_decode($this->apto, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->apto = strip_tags($this->apto);
         if (!NM_is_utf8($this->apto))
         {
             $this->apto = sc_convert_encoding($this->apto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->apto = str_replace('<', '&lt;', $this->apto);
         $this->apto = str_replace('>', '&gt;', $this->apto);
         $this->Texto_tag .= "<td>" . $this->apto . "</td>\r\n";
   }
   //----- inapto
   function NM_export_inapto()
   {
         $this->inapto = html_entity_decode($this->inapto, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->inapto = strip_tags($this->inapto);
         if (!NM_is_utf8($this->inapto))
         {
             $this->inapto = sc_convert_encoding($this->inapto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->inapto = str_replace('<', '&lt;', $this->inapto);
         $this->inapto = str_replace('>', '&gt;', $this->inapto);
         $this->Texto_tag .= "<td>" . $this->inapto . "</td>\r\n";
   }
   //----- modalidade
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_atestado_aptidao'][$path_doc_md5][1] = $this->Tit_doc;
?>
