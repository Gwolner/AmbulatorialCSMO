  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_alterar_email1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate senha_usuario
  function do_ajax_control_alterar_email1_mob_validate_senha_usuario()
  {
    var nomeCampo_senha_usuario = "senha_usuario";
    var var_senha_usuario = scAjaxGetFieldText(nomeCampo_senha_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_alterar_email1_mob_validate_senha_usuario(var_senha_usuario, var_script_case_init, do_ajax_control_alterar_email1_mob_validate_senha_usuario_cb);
  } // do_ajax_control_alterar_email1_mob_validate_senha_usuario

  function do_ajax_control_alterar_email1_mob_validate_senha_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "senha_usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_alterar_email1_mob_validate_senha_usuario_cb
  // ---------- Form
  function do_ajax_control_alterar_email1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_alterar_email1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_senha_usuario = scAjaxGetFieldText("senha_usuario");
    ...
    scAjaxProcOn();
    x_ajax_control_alterar_email1_mob_submit_form(var_senha_usuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_alterar_email1_mob_submit_form_cb);
  } // do_ajax_control_alterar_email1_mob_submit_form

  function do_ajax_control_alterar_email1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_alterar_email1_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_alterar_email1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_alterar_email1_mob_navigate_form

  function do_ajax_control_alterar_email1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_alterar_email1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_alterar_email1_mob_navigate_form_cb
  function sc_hide_control_alterar_email1_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_alterar_email1_mob_form
  ...
  ajax_field_list[0] = "senha_usuario";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "senha_usuario": {"label": "Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "senha_usuario": new Array()
  };
  ajax_field_mult["senha_usuario"][1] = "senha_usuario";

  var ajax_field_id = {
    "senha_usuario": new Array("hidden_field_label_senha_usuario", "hidden_field_data_senha_usuario")
  };
