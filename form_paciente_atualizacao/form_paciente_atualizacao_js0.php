<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_paciente" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_paciente']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_paciente_atualizacao"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['where_detal']))
  {
?>  
...
function cep_cep(num_cep, campos_cep)
{
   ...
   jsrsExecute("form_paciente_atualizacao_cep.php?cep=" + num_cep + "&onchange=s", recebe_cep, "cep", num_cep, false);
}
